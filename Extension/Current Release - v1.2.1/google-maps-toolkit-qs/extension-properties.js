			...
			apiKey:{
				...
				items: {
					...
					whyAPIKeyLink: {
						...
						component: "link",
						url: "https://googlegeodevelopers.blogspot.pt/2016/06/building-for-scale-updates-to-google.html"
					},
					howToAPIKey: {
						label: "Find here how to get your API Key: ",
						component: "link"
					},
					howToAPIKeyLink: {
						label: "https://developers.google.com/maps/documentation/javascript/get-api-key#key",
						component: "link",
						url: "https://developers.google.com/maps/documentation/javascript/get-api-key#key"
					}
